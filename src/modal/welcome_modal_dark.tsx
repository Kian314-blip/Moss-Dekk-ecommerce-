...
const Welcome_Modal_Dark: React.FC<ModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="fixed inset-0 z-50 bg-white bg-opacity-80 flex justify-center items-center">
            <div ref={modalRef} className="w-[636px] max-h-[90vh] overflow-y-auto hide-scrollbar flex flex-col items-center pt-[28px] pl-[12px] pr-[24px] bg-black rounded-[4px] max-[455px]:pt-[14px] max-[455px]:pl-[6px] max-[455px]:pr-[12px]">
                ...
                <div className='w-full flex justify-center pb-[24px] max-[455px]:pb-[12px]'>
                    <p className='text-lg leading-7 font-normal text-white max-[455px]:text-sm'>Ønsker du å Bestille tid for DEKKSKIFT?</p>
                </div>
                ...
                <div className='w-full bg-[#1F1F1F] py-[24px] pl-[28px] flex flex-col rounded-[4px] max-[455px]:py-[12px] max-[455px]:pl-[14px] mb-[27px] max-[455px]:mb-[13px]'>
                ...
                {showCalendar && (
                    <div className='flex flex-col pb-[9px] w-full'>
                        <div className='flex flex-col'>
                            <p className='text-3xl leading-9 font-semibold text-white max-[455px]:text-xl'>Dekkhotell: <span className='text-3xl leading-9 font-semibold text-[#73C018] max-[455px]:text-xl'>1190.-</span></p>
                            <p className='text-lg leading-7 font-normal text-white max-[455px]:text-sm'>inkl, skift, vask, lagring og forsikring</p>
                        </div>
